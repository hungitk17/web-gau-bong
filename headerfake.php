...
if(!(mysqli_query($conn,"set names 'utf8'")))
                ...
                ?>                
				<div class="col-md-2" onclick="xemgiohang();"><a href="index.php?giohang=true&&trang=1"><i class="fas fa-shopping-cart"></i> Giỏ hàng<sup><span class="badge badge-info" id="soluongsp">0</span></sup></a></div>
            </div>
        </div>
        <!--<div class="col-md-9 ">
            <div class="row justify-content-lg-end  justify-content-sm-center">
