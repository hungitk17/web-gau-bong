...
class Pagination
{
    ...
    {   
        ...
        if ($this->_config['total_record'] > $this->_config['limit'])
        {
            ...
            if ($this->_config['current_page'] > 1)
            {
                $p .= '<li class="page-item"><a class="page-link" href="'.$this->__link('1').'">Trang Đầu</a></li>';
                $p .= '<li class="page-item"><a class="page-link" href="'.$this->__link($this->_config['current_page']-1).'">Lùi 1 Trang</a></li>';
            }
            ...
            if ($this->_config['current_page'] < $this->_config['total_page'])
            {
                $p .= '<li><a class="page-link" href="'.$this->__link($this->_config['current_page'] + 1).'">Tiến 1 Trang</a></li>';
                $p .= '<li><a class="page-link" href="'.$this->__link($this->_config['total_page']).'">Trang cuối</a></li>';
            }
